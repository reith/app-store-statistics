...
class Application {
    ...
    @Bean
    fun demo(repository: AppStatisticsRepo, service: AppStatisticsReporterService, ctx: ApplicationContext) = CommandLineRunner {
        ...
        val newstats = service.getStats(startDate, endDate, 0)
        println("New Stats: $newstats")

        Thread.sleep(20000)

        val neweststats = service.getStats(startDate, endDate, 0)
        println("Newest Stats: $neweststats")
    }
}
